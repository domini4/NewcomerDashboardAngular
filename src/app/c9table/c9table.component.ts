...
@Component({
  selector: 'app-c9table',
  templateUrl: './c9table.component.html',
  styleUrls: ['./c9table.component.css']
})
export class C9tableComponent implements OnChanges {
  ...
  ngOnChanges(changes: SimpleChanges) {
    this.getcommentsapi.getRepoComments(this.repo, 9).subscribe(data=>{
      this.data = data;
