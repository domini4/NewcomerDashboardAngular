...
@Component({
  ...
  templateUrl: './c2table.component.html',
  styleUrls: ['./c2table.component.css']
})
export class C2tableComponent implements OnChanges {
  ...
  ngOnChanges(changes: SimpleChanges) {
    this.getcommentsapi.getRepoComments(this.repo, 2).subscribe(data=>{
      this.data = data;
